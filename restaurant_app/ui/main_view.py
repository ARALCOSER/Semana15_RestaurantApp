...
class MainView(tk.Frame):
    def __init__(self, master, restaurante_servicio, usuario_actual, al_cerrar_sesion):
        ...
        # Semana 15: referencias de la nueva seccion de Ventas.
    ...
    # -------------------------------------------------------------------
    # Ventas: nueva seccion de la Semana 15 para estudiar el flujo
    # accion del usuario -> boton -> command= -> callback -> servicio ->
    # persistencia -> respuesta visual. Relaciona un Usuario con un
    # Producto para registrar una venta simple.
    # -------------------------------------------------------------------
